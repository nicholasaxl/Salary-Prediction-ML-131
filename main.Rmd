...
plot1 <- ggplot(comparison_table1, aes(x = Real, y = Predicted)) +
  geom_point() +
  ggtitle("Comparison Plot - Training Data") +
  xlab("Real Values") +
...
plot2 <- ggplot(comparison_table2, aes(x = Real, y = Predicted)) +
  geom_point() +
  ggtitle("Comparison Plot - Test Data") +
  xlab("Real Values") +
  ylab("Predicted Values") +
  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed") +
  theme_minimal()
...
head(comparison_table1)
residuals1 <- predicted_values3 - encoded_salaries_train$salary_in_usd
train_mse <- mean(residuals1^2)
train_mse
```
